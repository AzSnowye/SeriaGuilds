...
public interface SQLitePartiesDao extends PartiesDao {
	String QUERY_UPDATE = "INSERT OR REPLACE INTO `<prefix>parties` (`id`, `name`, `tag`, `leader`, `description`, `motd`, `color`, `kills`, `password`, `home`, `protection`, `experience`, `follow`, `isopen`, `created_at`, `tax_last_paid`, `tax_last_payer`)" +
			" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
